...
<div class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td></td>
      <td>
        <a href="infosPatient.php?idP=<?php echo $row['id_patient']; ?>" class="btn btn-primary"><i class="fa-solid fa-file" title="afficher"></i></a>
      </td>
      <td>
        <button type="button" class="btn btn-primary" id="editbtn"><i class="fa-solid fa-file-pen"></i></button>
      </td>
      <td>
